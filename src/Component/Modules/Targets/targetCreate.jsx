...
const TargetCreate = ({ togglePopup, existingTargets = [] }) => {
  ...
  const handleCreateKeyword = async () => {
    ...
    try {
      const targetResponse = await axios.post(`${window.runtimeConfig.VITE_APP_API_CASE_MAN}/api/case-man/v1/target`, payloadData, {
        headers: {
    ...
    <div className="popup-overlay">
      <div className="popup-container">
        ...
        <div className="popup-content">
          <h5 className="mb-3">Add New Target</h5>
          <form
            onSubmit={(e) => {
              e.preventDefault();
              handleCreateKeyword();
